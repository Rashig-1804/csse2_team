...
// Exported from GameBuilder on 2026-03-05T22:42:57.097Z
// How to use this file:
// 1) Save as assets/js/adventureGame/GameLevelGameLevelSomethingJs.js in your repo.
// 2) Reference it in your runner or level selector. Examples:
//    import GameLevelPlanets from '/assets/js/GameEnginev1/GameLevelPlanets.js';
//    import GameLevelGameLevelSomethingJs from '/assets/js/adventureGame/GameLevelGameLevelSomethingJs.js';
//    export const gameLevelClasses = [GameLevelPlanets, GameLevelGameLevelSomethingJs];
...
class GameLevelGameLevelSomethingJs {
    constructor(gameEnv) {
        ...
        const dbarrier_1 = {
            id: 'dbarrier_1', x: 67, y: 122, width: 231, height: 23, visible: false,
            hitbox: { widthPercentage: 0.0, heightPercentage: 0.0 },
            fromOverlay: true
        };

        const dbarrier_2 = {
            id: 'dbarrier_2', x: 13, y: 12, width: 52, height: 131, visible: false,
            hitbox: { widthPercentage: 0.0, heightPercentage: 0.0 },
            fromOverlay: true
        };

        const dbarrier_3 = {
            id: 'dbarrier_3', x: 484, y: 342, width: 75, height: 13, visible: false,
            hitbox: { widthPercentage: 0.0, heightPercentage: 0.0 },
            fromOverlay: true
        };
...
export default GameLevelGameLevelSomethingJs;
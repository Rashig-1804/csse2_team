...
<script type="module">
    ...
    import GameLevelGameLevelSomethingJs from "{{site.baseurl}}/assets/js/GameEnginev1/GameLevelGameLevelSomethingJs.js";
    import { pythonURI, javaURI, fetchOptions } from '{{site.baseurl}}/assets/js/api/config.js';

    const gameLevelClasses = [GameLevelGameLevelSomethingJs];
